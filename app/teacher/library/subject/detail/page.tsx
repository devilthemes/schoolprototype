...
const initialFiles: FileItem[] = [
  ...
  {
    id: 11,
    name: "Historical Math Proofs.zip",
    type: "zip",
    size: "45.2 MB",
    url: "#",
  ...
  {
    id: 25,
    name: "Vector Analysis Diagrams.png",
    type: "image",
    size: "4.2 MB",
    url: "#",
    ...
    <Container fluid className="py-4 bg-light min-vh-100">
      ...
      <div className="explorer-header rounded shadow-sm">
        ...
        <Breadcrumb className="mb-0">
          ...
          <Breadcrumb.Item href="/teacher/library">Library</Breadcrumb.Item>
